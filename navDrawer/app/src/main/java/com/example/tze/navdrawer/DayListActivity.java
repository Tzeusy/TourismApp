...
import com.example.tze.navdrawer.dummy.DummyContent;

import java.util.List;

/**
 * An activity representing a list of Itinerary. This activity
...
public class DayListActivity extends AppCompatActivity {
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(DayDetailFragment.ARG_ITEM_ID, item.id);
        ...
        SimpleItemRecyclerViewAdapter(DayListActivity parent,
